...
*Defined in [interfaces.ts:3](https://github.com/EOSIO/ricardian-template-toolkit/blob/76dafef/src/interfaces.ts#L3)*
...
*Defined in [interfaces.ts:2](https://github.com/EOSIO/ricardian-template-toolkit/blob/76dafef/src/interfaces.ts#L2)*
